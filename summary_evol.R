...
png(filenames_out[1])
plot(pageCount, lty=3, col=1, main="Evolution in time of the total number of articles", xlab="months", ylab="tot_num_articles")
lines(lowess(pageCount),lty=3, col=2)
dev.off()
png(filenames_out[2])
plot(pageCount, log="y", lty=3, col=1, main="Evolution in time of the total number of articles", xlab="months", ylab="tot_num_articles")
lines(lowess(pageCount), log="y",lty=3, col=2)
dev.off()
png(filenames_out[3])
plot(pageCount, log="xy", lty=3, col=1, main="Evolution in time of the total number of articles", xlab="months", ylab="tot_num_articles")
...
pageLenSum=input[[1]]
png(filenames_out[4])
plot(pageLenSum, lty=3, col=1, main="Evolution in time of the total size of articles", xlab="months", ylab="tot_size_in_bytes")
lines(lowess(pageLenSum),lty=3, col=2)
dev.off()
png(filenames_out[5])
plot(pageLenSum, log="y", lty=3, col=1, main="Evolution in time of the total size of articles", xlab="months", ylab="tot_size_in_bytes")
lines(lowess(pageLenSum), log="y",lty=3, col=2)
dev.off()
png(filenames_out[6])
plot(pageLenSum, log="xy", lty=3, col=1, main="Evolution in time of the total size of articles", xlab="months", ylab="tot_size_in_bytes")
...
contribs=input[[1]]
png(filenames_out[7])
plot(contribs, lty=3, col=1, main="Evolution in time of the total contribs", xlab="months", ylab="tot_num_contribs")
lines(lowess(contribs),lty=3, col=2)
dev.off()
png(filenames_out[8])
plot(contribs, log="y", lty=3, col=1, main="Evolution in time of the total contribs", xlab="months", ylab="tot_num_contribs")
lines(lowess(contribs), log="y",lty=3, col=2)
dev.off()
png(filenames_out[9])
plot(contribs, log="xy", lty=3, col=1, main="Evolution in time of the total contribs", xlab="months", ylab="tot_num_contribs")
